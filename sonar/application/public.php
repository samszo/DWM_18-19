...
<html lang="fr-FR">
    <head>
        ...
        <link rel="stylesheet" href="scripts/res/cercle_audio.css"/>
    ...
    <header>
        ...
        <div class="force">
            <div id="orbit">
                <div position="relative" id="audio_conteneur2"></div></div>
                <svg margin="auto"  position="absolute" width="960" height="800" viewBox="-480 -250 960 500">
